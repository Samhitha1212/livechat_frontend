...
<input class=" text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" onChange={e=>{setEmail(e.target.value)}} type="email" id='email-login' placeholder='john@example.com'/>
</div>
<div class="mt-4">
...
<input class=" text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" onChange={e=>{setPassword(e.target.value)}} id='password-login' placeholder='Must be atleast 6 characters'   type="password"/>
</div>
<div className="mt-8">
